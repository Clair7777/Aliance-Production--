  ...
  <header header-about>
    <div class="section section-grey-about">
      <div class="container container-about">
        <div class="header-content header-content-about-grey">
          <div class="seporator"></div>
          <h1 class="header-title header-title-grey">
            о компании
          </h1>
        </div>
  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-top">
        ...
        <a href="tel:+74996861014" class="footer-phone footer-phone-number">+7 (499) 686-10-14</a>
